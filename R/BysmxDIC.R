...
#'
#'
#' Bayesian mixed effect model with random intercept and slopes provides inference with deviance information criterion (DIC). Data longitudinally measured missing value and having batched
#' information.
...
BysmxDIC<-function(m,tmax,t,group,chains,iter,out,data){
  timepoints=t
  gendergrp=group
  w1<-m[1]
